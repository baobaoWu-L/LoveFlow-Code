...
**References**:
- **LoveFlow's own design language** — the clean, considered aesthetic with warm pink undertones. The LoveFlow pink as a human accent. Lots of breathing room. Typography-forward.
...
**Tone**: Anthropomorphic warmth meets terminal precision. The LoveFlow pink is the thread that ties everything together — it's the human element in a technical world.
...
**Color**:
- Primary: LoveFlow pink (`rgb(235,100,150)` / warm pink)
...
**Differentiation**: The LoveFlow-Code brand sits at the intersection of "serious tool" and "community project." It should feel like warm design principles applied to an open-source context — less corporate polish, more human craft. The pink mascot and the "LoveFlow" naming hint at personality that the design should honor.
...
- LoveFlow Pink: `rgb(235,100,150)` / warm pink
- LoveFlow Bright: `rgb(255,120,170)` / bright pink
- Permission Pink: `rgb(200,80,150)`
- Auto Accept Pink: `rgb(215,80,130)`
- Plan Mode Pink: `rgb(180,60,120)`

### Logo
- LoveFlow text + pink heart/checkmark icon
